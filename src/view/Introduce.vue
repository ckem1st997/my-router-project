<template>
  <body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            <h3 class="py-3">Giới thiệu <span>Thành viên</span></h3>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container" style="margin-top: 116px">
      <div class="row">
        <div class="col-11 mx-auto profile" v-for="item in list" :key="item">
          <div class="py-3 px-2 px-lg-4 py-lg-5">
            <div class="row">
              ...
              <div class="infoBox col-12 col-lg-6 mt-2 mt-lg-0">
                ...
                <div class="name">
                  <p><span>I'm</span> {{ item.name }}</p>
                  <p><span class="ion-android-globe"></span> {{ item.fb }}</p>
                </div>
                <hr />
                ...
                <div class="detailInfo">
                  <div class="row my-2">
                    ...
                    <div class="col-lg-8 col-12 b">{{ item.name }}</div>
                  </div>
                  <div class="row my-2">
                    <div class="col-lg-4 col-12 boldd">Lớp</div>
                    <div class="col-lg-8 col-12 b">{{ item.lop }}</div>
                  </div>
                  <div class="row my-2">
                    <div class="col-lg-4 col-12 boldd">Tình Trạng</div>
                    <div class="col-lg-8 col-12 b">{{ item.tinhTrang }}</div>
                  </div>
                  <div class="row">
                    <div class="col-lg-4 col-12 boldd">Tuổi</div>
                    <div class="col-lg-8 col-12 b">{{ item.tuoi }}</div>
                  </div>
                  <div class="row my-2">
                    <div class="col-lg-4 col-12 boldd">Nhiệm vụ</div>
                    <div class="col-lg-8 col-12 b">{{ item.nhiemvu }}</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <!-- <div class="col-11 mx-auto bg-danger contact text-center">
				<div class="social col-12">
					<a href="https://www.facebook.com/qjimkkml/" target="_blank">
						<span class="ion-social-facebook mr-4 mr-lg-5"></span>
					</a>
					<a href="https://www.instagram.com/tdl.2611/" target="_blank">
...
export default {
  ...
  async created() {
    // đường dẫn để lấy dữ liệu từ API với phương thức GET
    const url = "http://www.apivuejs.somee.com/accountapi/User/info";
    // gọi axios để call API
    await axios
      .get(url)
      // kết quả trả về gán vào biến
      .then((res) => {
        this.list = res.data;
      })
      .catch((error) => {
