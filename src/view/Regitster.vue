        ...
        <div class="row d-flex">
          <div class="col-lg-6">
            <div class="card1 pb-5">
              ...
              >
                <img
                  src="https://www.elleman.vn/wp-content/uploads/2018/03/18/phong-cach-thoi-trang-duong-pho-elle-man-feature.jpg"
                  class="image"
                />
              </div>
            </div>
...
export default {
  methods: {
    async SignUp() {
      ...
      const url = "http://apivuejs.somee.com/accountapi/User/addAcount";
      const result = await axios
        ...
        .catch((error) => {
          ...
          this.show(
            "foo-css",
            "warn",
            "Thông tin chưa đúng, xin vui lòng nhập lại !"
          );
        });
        //nếu thành công thì thông báo
      if (result.data) {
        this.show("foo-css", "success", "Đăng ký thành công nha !");
